 ...
 */
package pkg3153assignment1;

import java.util.*;

/**
 *
 * @author Imraan Boukarfi
 */
public class Main {
    ...
    /**
     * method that runs calls all functional methods in the class and presents it with desired output
     * @param args 
     */
    ...
    /**
     * method that gets the value of heuristic value
     * 
     * @return heuristic field value
     */
